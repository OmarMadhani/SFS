...
// Source: The structs below were provided by the course instructor Ahmad Abdullah
...
// modified version of the int get_fat(int i) function provided by the course instructor
uint16_t get_fat_unsigned(uint16_t i);

// int get_fat(int i) was provided by the course instructor
int get_fat(int i);

// int getFreeBlocks() was provided by the course instructor
int getFreeBlocks();
...
void getContentsOfFile(FILE* fileSystemPtr, uint16_t logicalCluster, char* fullFileName, int fileSize);
void diskget(FILE* fileSystemPtr, char* fileName);
long int getFileSize(char* fileToInsert);
void diskput(FILE* fileSystemPtr, char* fileToInsert);
int checkIfFileExistsInRootDirectory(FILE* fileSystemPtr, char* fileToInsert);
